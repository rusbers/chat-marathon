...
})({"2vh6c":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "c003d5999d38fdef";
...
},{}],"2MUsd":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "serverConnection", ()=>serverConnection
);
...
var _authentificationJs = require("./authentification.js");
document.addEventListener('DOMContentLoaded', ()=>{
    serverConnection();
    _messageJs.showMessagesHistory();
});
_viewJs.UI_ELEMENTS.FORMS.AUTHENTIFICATION.addEventListener('submit', _authentificationJs.emailValidation);
_viewJs.UI_ELEMENTS.FORMS.AUTHENTIFICATION_CODE.addEventListener('submit', _authentificationJs.sendAuthentificationCode);
_viewJs.UI_ELEMENTS.FORMS.SETTING_NAME.addEventListener('submit', _authentificationJs.setUserName);
function serverConnection() {
    const authentificationToken = _jsCookieDefault.default.get('token');
    if (!authentificationToken) return;
    _viewJs.UI_ELEMENTS.CONTROLS.AUTHORIZATION.textContent = _viewJs.MESSAGES.LOG_OUT;
    const socketUrl = `${_apiJs.API.WEBSOCKET}${authentificationToken}`;
    const socketConnection = new WebSocket(socketUrl);
    socketConnection.addEventListener('open', function() {
        _viewJs.UI_ELEMENTS.FORMS.SEND_MESSAGE.addEventListener('submit', function(e) {
            e.preventDefault();
            _messageJs.sendMessage(socketConnection, this);
        });
    });
    socketConnection.addEventListener('message', function(event) {
        _messageJs.renderMessage(JSON.parse(event.data));
    });
}
_viewJs.UI_ELEMENTS.MESSAGES_HISTORY.addEventListener('scroll', function() {
    const isScrollTop = this.scrollTop === 0;
    const renderedMessagesStep = -20;
    ...
    let renderedMessagesCount = JSON.parse(localStorage.getItem('renderedMessagesCount'));
    let newMessagesToRenderOnScrollTop = [];
    if (isScrollTop) {
        newMessagesToRenderOnScrollTop = messagesHistory.slice(renderedMessagesCount + renderedMessagesStep, renderedMessagesCount);
        if (newMessagesToRenderOnScrollTop.length === 0) {
            renderedMessagesWrapper.textContent = 'No messages to show';
            _viewJs.UI_ELEMENTS.MESSAGES_HISTORY.prepend(renderedMessagesWrapper);
            return;
        }
        newMessagesToRenderOnScrollTop.forEach((message)=>{
            renderedMessagesWrapper.append(_messageJs.renderMessage(message));
        });
        _viewJs.UI_ELEMENTS.MESSAGES_HISTORY.prepend(renderedMessagesWrapper);
...
},{"./view.js":"6bmUi","./message.js":"iolzh","./api.js":"CqMsI","js-cookie":"c8bBu","./authentification.js":"2NM3s","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"6bmUi":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
parcelHelpers.export(exports, "getMessageTemplate", ()=>getMessageTemplate
);
...
const MODAL = new Map([
    [
        UI_ELEMENTS.CONTROLS.SETTINGS,
        UI_ELEMENTS.MODAL.SETTINGS
    ],
    [
        UI_ELEMENTS.CONTROLS.AUTHORIZATION,
        UI_ELEMENTS.MODAL.AUTHENTIFICATION
    ]
]);
...
},{}],"iolzh":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "sendMessage", ()=>sendMessage
);
parcelHelpers.export(exports, "fillMessage", ()=>fillMessage
);
...
function getInputValue(thisForm) {
    const thisInput = thisForm.querySelector(_viewJs.CLASSES.FORM_INPUT);
...
function fillMessage(messageElements, messageDetails) {
    const isUserEmail = messageDetails.user.email === _jsCookieDefault.default.get('mail');
    if (isUserEmail) messageElements.messageWrapper.classList.add(_viewJs.CLASSES.USER_MESSAGE);
    ...
    messageElements.messageTime.textContent = _dateFns.format(new Date(messageDetails.createdAt), 'HH:mm dd/MM');
}
function sendMessage(socket, thisForm) {
    ...
    _viewJs.resetInput(thisForm);
}
function renderMessage(messageDetails) {
    const messageNode = _viewJs.getMessageTemplate();
...
async function showMessagesHistory() {
    ...
    const renderedMessagesWrapper = document.createElement('div');
    const test = messagesHistory.slice(-42);
    test.slice(-20).forEach((message)=>{
        renderedMessagesWrapper.append(renderMessage(message));
    });
    _viewJs.UI_ELEMENTS.MESSAGES_HISTORY.append(renderedMessagesWrapper);
    _viewJs.scrollDown();
    // TO REMADE IN ONE FUNCTION that has set as parameter an array:
    if (!localStorage.getItem('messagesHistory')) localStorage.setItem('messagesHistory', JSON.stringify(test));
    if (!localStorage.getItem('rendered messages')) localStorage.setItem('rendered messages', JSON.stringify([
...
async function getMessagesHistory() {
    try {
        const requestMessagesHistory = await _networkJs.sendRequest(_apiJs.API.MESSAGES, 'GET');
        if (!_networkJs.isStatusOK(requestMessagesHistory)) throw _viewJs.MESSAGES.ERROR.WRONG_HTTP_STATUS;
...
},{"./view.js":"6bmUi","./network.js":"1IkNg","./api.js":"CqMsI","date-fns":"9yHCA","js-cookie":"c8bBu","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1IkNg":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "sendRequest", ()=>sendRequest
);
parcelHelpers.export(exports, "isStatusOK", ()=>isStatusOK
);
parcelHelpers.export(exports, "serverRequestValidation", ()=>serverRequestValidation
);
var _jsCookie = require("js-cookie");
var _jsCookieDefault = parcelHelpers.interopDefault(_jsCookie);
...
async function serverRequestValidation(thisElement, apiLink, HttpMethod = 'GET', bodyRequestKey) {
    const bodyValue = _message.getInputValue(thisElement);
    const requestBody = {
        [bodyRequestKey]: bodyValue
    };
...
},{"js-cookie":"c8bBu","./message":"iolzh","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"c8bBu":[function(require,module,exports) {
...
},{}],"CqMsI":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"2NM3s":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "emailValidation", ()=>emailValidation
);
parcelHelpers.export(exports, "setUserName", ()=>setUserName
);
parcelHelpers.export(exports, "sendAuthentificationCode", ()=>sendAuthentificationCode
);
var _apiJs = require("./api.js");
var _viewJs = require("./view.js");
var _messageJs = require("./message.js");
...
async function emailValidation() {
    try {
        const emailValidationResult = await _networkJs.serverRequestValidation(this, _apiJs.API.AUTHORIZATION, 'POST', 'email');
        const responseSucces = await emailValidationResult.succes;
        const responseError = await emailValidationResult.error;
        if (responseError) throw _viewJs.MESSAGES.ERROR.WRONG_HTTP_STATUS;
        _jsCookieDefault.default.set('mail', responseSucces.email);
        _viewJs.closePopup(this);
        _viewJs.openPopup(_viewJs.UI_ELEMENTS.MODAL.AUTHENTIFICATION_CODE);
        _viewJs.UI_ELEMENTS.CONTROLS.AUTHORIZATION.textContent = _viewJs.MESSAGES.LOG_OUT;
    } catch (error) {
        console.log(error);
        return;
    } finally{
        _viewJs.resetInput(this);
    }
}
async function setUserName() {
    try {
        const setUserNameRequest = await _networkJs.serverRequestValidation(this, _apiJs.API.AUTHORIZATION, 'PATCH', 'name');
        const responseError = await setUserNameRequest.error;
        if (responseError) throw _viewJs.MESSAGES.ERROR.WRONG_HTTP_STATUS;
        _mainJs.serverConnection();
        _viewJs.closePopup(this);
    } catch (error) {
        console.log(error);
        return;
...
function sendAuthentificationCode() {
    const authorizationCode = _messageJs.getInputValue(this);
    if (!authorizationCode) return;
    _jsCookieDefault.default.set('token', authorizationCode);
    _viewJs.resetInput(this);
    _viewJs.closePopup(this);
    _viewJs.openPopup(_viewJs.UI_ELEMENTS.MODAL.SETTINGS);
}

},{"./api.js":"CqMsI","./view.js":"6bmUi","./message.js":"iolzh","./network.js":"1IkNg","js-cookie":"c8bBu","./main.js":"2MUsd","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["2vh6c","2MUsd"], "2MUsd", "parcelRequire25d8")

//# sourceMappingURL=index.9d38fdef.js.map
