...
_viewJs.UI_ELEMENTS.FORMS.AUTHENTIFICATION.addEventListener('submit', _authentificationJs.userAuthentification);
...
function serverConnection() {
    ...
    socketConnection.addEventListener('open', function() {
        _viewJs.UI_ELEMENTS.FORMS.SEND_MESSAGE.addEventListener('submit', function() {
...
},{"./view.js":"2GA9o","./message.js":"lGCpb","./api.js":"6yDOL","js-cookie":"c8bBu","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./authentification.js":"8mzWK"}],"2GA9o":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
parcelHelpers.export(exports, "GetMessageNodeElements", ()=>GetMessageNodeElements
);
...
function fillMessage(messageElements, messageDetails) {
    if (messageDetails.user.email === _jsCookieDefault.default.get('mail')) messageElements.messageWrapper.classList.add(_viewJs.CLASSES.USER_MESSAGE);
    ...
    messageElements.messageTime.textContent = _dateFns.format(new Date(messageDetails.createdAt), 'HH:mm');
}
...
function renderMessage(messageDetails) {
    ...
    _viewJs.UI_ELEMENTS.MESSAGES_HISTORY.append(messageNode);
    _viewJs.scrollDown();
}
...
},{"./view.js":"2GA9o","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./network.js":"hJPj8","./api.js":"6yDOL","date-fns":"9yHCA","js-cookie":"c8bBu"}],"hJPj8":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"8mzWK":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
async function userAuthentification() {
    const mail = _messageJs.getInputValue(this);
    if (!mail) return;
    const mailBody = {
        email: mail
    };
    ...
    try {
        const authentificationRequest = await _networkJs.sendRequest(_apiJs.API.AUTHORIZATION, 'POST', mailBody);
        if (!_networkJs.isStatusOK(authentificationRequest)) throw _viewJs.MESSAGES.ERROR.WRONG_HTTP_STATUS;
        _viewJs.closePopup(this);
        _viewJs.openPopup(UI_ELEMENTS.MODAL.AUTHENTIFICATION_CODE);
        UI_ELEMENTS.CONTROLS.AUTHORIZATION.textContent = _viewJs.MESSAGES.LOG_OUT;
    } catch (error) {
        console.log(error);
        return;
    } finally{
...
async function setUserName() {
    const userName = _messageJs.getInputValue(this);
    const nameBody = {
        name: userName
    };
    if (!userName) throw _viewJs.MESSAGES.ERROR.USER_NAME;
    try {
        const setUserNameRequest = await _networkJs.sendRequest(_apiJs.API.AUTHORIZATION, 'PATCH', nameBody);
        if (!_networkJs.isStatusOK(setUserNameRequest)) throw _viewJs.MESSAGES.ERROR.WRONG_HTTP_STATUS;
        _viewJs.closePopup(this);
    } catch (error) {
        console.log(error);
        return;
...
},{"./api.js":"6yDOL","./view.js":"2GA9o","./network.js":"hJPj8","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./message.js":"lGCpb"}]},["huMbS","bDbGG"], "bDbGG", "parcelRequire25d8")
